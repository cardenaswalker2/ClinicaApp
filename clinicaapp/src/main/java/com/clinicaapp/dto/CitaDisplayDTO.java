...
public class CitaDisplayDTO {
    ...
    private String motivo; // <-- NUEVO PARA VER_CITA
    ...
    private String nombreDoctor; // <-- NUEVO PARA LA VERSIÓN PREMIUM
    private String imagenClinicaUrl; // <-- NUEVO PARA MOSTRAR LA FOTO DE LA CLÍNICA
    ...
    public CitaDisplayDTO(Cita cita, Usuario usuario, Clinica clinica, Mascota mascota, List<Servicio> servicios) {
        ...
        this.imagenClinicaUrl = (clinica != null) ? clinica.getImagenUrl() : null;
        this.direccionClinica = (clinica != null) ? clinica.getDireccion() : "N/A";
        this.telefonoClinica = (clinica != null) ? clinica.getTelefono() : "N/A";
    ...
    public String getImagenClinicaUrl() { return imagenClinicaUrl; }
    public void setImagenClinicaUrl(String imagenClinicaUrl) { this.imagenClinicaUrl = imagenClinicaUrl; }
    ...
    public void setTelefonoClinica(String telefonoClinica) { this.telefonoClinica = telefonoClinica; }
